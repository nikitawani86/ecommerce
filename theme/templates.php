...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Nikita Wani</a></span></p>
...
<script src="<?php echo web_root; ?>js/main.js"></script> 
 ...
 <!-- <img src="images/home/online_shopping.jpg" class="girl img-responsive" alt="" />-->
